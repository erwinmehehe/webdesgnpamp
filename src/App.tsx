...
import { InteractivePortfolioPage } from "@/pages/InteractivePortfolio";
...
const routes: RouteDefinition[] = [
  ...
  { pattern: "/interactive-portfolio", render: () => <InteractivePortfolioPage /> },
